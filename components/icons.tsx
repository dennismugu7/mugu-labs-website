...
export const socialIcons: Record<string, (p: IconProps) => ReactElement> = {
  ...
  youtube: ({ className }) => (
    // viewBox is tight to the mark (it spans y 3.545-20.455 of the 24 box), so
    // the svg's box is the mark's box and the CSS can size it at tile height.
    <svg className={className} viewBox="0 3.545 24 16.909" fill="currentColor" aria-hidden="true">
